...
def chapterFour(pl:Player):
    ...
    print(
        ...
        colored("   )\\   (", "yellow") + colored(" /(     )         ( /(", "red") + colored("   (   (     ( /(  ",
                                                                                            "yellow") + "\n" +
        colored(" (((_)  ", "red") + colored(")\\()) (", "yellow") + colored(" /(  `  )   )", "red") + colored(
            "\\()) ))\\  )(   ", "yellow") + colored(" )\\())", "red") + "\n" +
        colored(" )\\___ (", "yellow") + colored("(_)\\ ", "red") + colored(" )(_)", "yellow") + colored(") /(/( ",
                                                                                                       "red") + colored(
            " (_))/ /((_)((", "yellow") + colored(")\\  ((_)\\  ", "red") + "\n" +
        colored("((", "red") + "/ __|| |" + colored("(_)", "red") + colored("((_)_ ((_)_\\ ",
                                                                            "yellow") + "| |_" + colored(" (_))   ((",
                                                                                                         "red") + "" + colored(
            "_)", "yellow") + " | | " + colored("(_) ", "yellow") + "\n" +
        " | (__ | ' \\ / _` || '_ \\)|  _|/ -_) | '_| |_  _|  " + "\n" +
    ...
    "\n с которыми легко расправились солдаты.Продвигаясь все глубже,"+colored("принц видит силуэт из своих снов,","yellow")+"" \
